...
type AuctionServiceClient interface {
	...
	Result(ctx context.Context, in *EmptyArgument, opts ...grpc.CallOption) (*Outcome, error)
}
...
func (c *auctionServiceClient) Result(ctx context.Context, in *EmptyArgument, opts ...grpc.CallOption) (*Outcome, error) {
	out := new(Outcome)
...
type AuctionServiceServer interface {
	...
	Result(context.Context, *EmptyArgument) (*Outcome, error)
...
func (UnimplementedAuctionServiceServer) Result(context.Context, *EmptyArgument) (*Outcome, error) {
...
func _AuctionService_Result_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuctionServiceServer).Result(ctx, req.(*EmptyArgument))
	}
	return interceptor(ctx, in, info, handler)
}
