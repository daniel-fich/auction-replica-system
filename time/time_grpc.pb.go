...
type TimeServiceClient interface {
	SetTime(ctx context.Context, in *Time, opts ...grpc.CallOption) (*EmptyMessage, error)
}
...
func (c *timeServiceClient) SetTime(ctx context.Context, in *Time, opts ...grpc.CallOption) (*EmptyMessage, error) {
	out := new(EmptyMessage)
	err := c.cc.Invoke(ctx, "/time.TimeService/SetTime", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TimeServiceServer interface {
	SetTime(context.Context, *Time) (*EmptyMessage, error)
...
func (UnimplementedTimeServiceServer) SetTime(context.Context, *Time) (*EmptyMessage, error) {
...
func _TimeService_SetTime_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/time.TimeService/SetTime",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TimeServiceServer).SetTime(ctx, req.(*Time))
	}
